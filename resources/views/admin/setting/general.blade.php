                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                        <label class="required">@lang('Event Posting Cost (Credit)')</label>
                                    </div>
                                    <div class="col-md-9 col-xs-12">
                                        <input class="form-control" type="number" name="event_credit" required
                                            value="{{ $general->event_credit }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <input class="form-control" step='any' type="number" name="upvote_credit"
                                            required value="{{ $general->upvote_credit }}">
                                    </div>
                                </div>
