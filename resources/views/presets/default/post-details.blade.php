                                        ...
                                        <div class="card--body">
                                            ...
                                            <div class="card-content">
                                                ...
                                                @if ($post->type == 'event')
                                                    ...
                                                    <div class="mb-3">
                                                        <p>@lang('Participant:') {{ $post->participant }}</p>
                                                    </div>

                                                    <div class="mb-3">
                                                        <p>@lang('Date:')
                                                            {{ __(showDateTime($post->start_date, 'd-m-Y')) }},
                                                            {{ __(showDateTime($post->end_date, 'd-m-Y')) }}</p>
                                                    </div>
                                                @endif
                                                ...
                                                <ul class="footer-item-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="actn-dropdown-box">
                                                            ...
                                                            @if (@$post->type == 'job' && auth()->id() != @$post->user_id)
        ...
        <div class="modal-dialog">
            <form id="post_report_form">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit"
                            class="btn btn-success post-details-report-modal">@lang('Send')</button>
                    </div>
                </div>
            </form>
        </div>
