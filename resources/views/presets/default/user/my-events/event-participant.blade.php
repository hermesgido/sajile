                                                ...
                                                @forelse($participants as $participant)
                                                    <tr>
                                                        <td class="text-center" data-label="Name">
                                                            {{ __($participant->user?->fullname) }}</td>
                                                        <td data-label="Fee">
                                                            {{ __($general->cur_sym) }}{{ showAmount($participant->fee) }}
                                                        </td>
                                                        <td data-label="Date">
                                                            {{ showDateTime($participant->created_at) }}<br>{{ diffForHumans($participant->created_at) }}
                                                        </td>
                                                        <td class="text-center" data-label="Details">
                                                            <a href="{{ route('user.profile.details', $participant->user?->id) }}"
