...
class CommentController extends Controller
{
    ...
    public function comment_vote(Request $request)
    {
        ...
        $userNotification->click_url = url('/') . '/details/' . $comment->post_id. '/' .slug($comment->posts->title);
        $userNotification->save();
    ...
    public function comment_report(Request $request)
    {
        ...
        $userNotification->click_url = url('/') . '/details/' . $comment->post_id . '/'. slug($comment->post->title);
        $userNotification->save();
